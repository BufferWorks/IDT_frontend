...
const ContestRedirect = () => {
  ...
  const handleManualAction = () => {
     ...
     // Deep link: idtapp://contest?contestId=<ID>
     const intentUrl = `intent://contest?contestId=${id}#Intent;scheme=idtapp;package=com.idt.app;S.browser_fallback_url=${fallbackUrl};end`;
     
     // For non-Android devices (e.g., iOS or Desktop Browser), immediately fallback to Play Store/Website.
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FF] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-2xl font-bold text-gray-900 font-['Play']">Opening IDT Contest Details...</h2>
...
export default ContestRedirect;
